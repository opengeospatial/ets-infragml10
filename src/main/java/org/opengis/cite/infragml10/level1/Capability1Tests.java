...
import org.opengis.cite.infragml10.ErrorMessageKeys;
import org.opengis.cite.infragml10.SuiteAttribute;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.infragml10.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/infragml10/rnc/atom.rnc");
